...
import { ArrowRight, Package, Zap, Code, Terminal, Wheat } from "lucide-react"
import Link from "next/link"

export default function FarmingTutorialPage() {
...
try {
  ...
  const farmTokensCode = `// Stake LP tokens in a farm to begin farming
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h1 className="font-heading text-4xl font-bold">Yield Farming Tutorial</h1>
            </div>
          ...
          <Card className="mb-8">
            ...
            <CardContent>
              <p>
                This tutorial will guide you through the process of participating in yield farming programs using the Saros SDK. 
                Yield farming allows you to earn additional tokens as rewards for staking your LP tokens in farming pools.
              </p>
          ...
          <div className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-2 mb-6">
              ...
              <li>LP tokens to farm (obtained by providing liquidity to pools)</li>
          ...
          <div className="mb-8">
            <h2 className="font-heading text-2xl font-bold mb-4">5. Start Farming</h2>
            <p className="text-muted-foreground mb-4">
              Stake your LP tokens in a farm to begin earning rewards.
            </p>
            <CodeBlock code={farmTokensCode} language="typescript" title="Start Farming" />

            <Card className="mt-6">
              <CardHeader>
                <CardTitle className="text-lg">Understanding Farming</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3 text-sm">
                ...
                <div>
                  <strong>3. Receive Confirmation:</strong> The function returns a transaction hash to confirm the farming operation.
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div>
                <strong>Risk vs Reward:</strong> Higher APY farms may come with higher risks, including impermanent loss and smart contract risks.
              </div>
              <div>
                <strong>Diversification:</strong> Consider diversifying your farming across multiple pools to reduce risk.
              </div>
              <div>
                <strong>Compound Rewards:</strong> Reinvesting your rewards can significantly increase your returns over time.
              </div>
              <div>
                <strong>Monitor Performance:</strong> Regularly check the performance of your farming positions and adjust as needed.
              </div>
              <div>
