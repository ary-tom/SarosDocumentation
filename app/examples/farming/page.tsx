...
export default function FarmingExamplePage() {
...
claimRewards().then(result => {
  ...
  const runCode = async () => {
    setIsRunning(true)
    setOutput("Running farming simulation...\n")

    // Simulate code execution
    setTimeout(() => {
      const mockOutput = `🌾 Farming Simulation Results:
• Operation: Start Farming
• Amount Staked: 100 LP Tokens
• Pool APY: 24.5%
• Estimated Transaction Hash: 5R77777777777777777777777777777777777777777
• Status: Success

🔄 Unstaking Simulation Results:
• Operation: Unstake Tokens
• Amount Unstaked: 50 LP Tokens
• Estimated Transaction Hash: 5S88888888888888888888888888888888888888888
• Status: Success

💰 Rewards Claim Simulation Results:
• Operation: Claim Rewards
• Rewards Claimed: 2.45 C98 Tokens
• Estimated Transaction Hash: 5T99999999999999999999999999999999999999999
• Status: Success
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container py-8">
        <div className="mx-auto max-w-4xl">
          {/* Header */}
          <div className="mb-8">
            <h1 className="font-heading text-4xl font-bold mb-4">Yield Farming Example</h1>
          ...
          <Card className="mb-8">
            <CardHeader className="flex flex-row items-center justify-between pb-4">
              <div>
                <CardTitle className="text-xl font-heading">Farming Operations Implementation</CardTitle>
                <CardDescription>Complete code example for yield farming</CardDescription>
              </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 mb-8">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Simulate the farming operations</CardDescription>
              </CardHeader>
              <CardContent>
                <Button onClick={runCode} disabled={isRunning} className="w-full">
                  <Play className="mr-2 h-4 w-4" />
                  {isRunning ? "Running..." : "Run Farming Simulation"}
                </Button>
                <p className="text-sm text-muted-foreground mt-4">
                  This simulation demonstrates the expected behavior of farming, unstaking, and claiming rewards.
              ...
              <CardContent>
                <div className="bg-muted rounded-lg p-4 min-h-[150px]">
                  <pre className="text-sm font-mono whitespace-pre-wrap">
                    {output || "Click 'Run Farming Simulation' to see the output here..."}
                  </pre>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    <code className="bg-muted px-1 rounded">SarosFarmService.stakePool</code> stakes LP tokens in a farming pool to begin earning rewards.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold mb-1">Unstake Tokens</h3>
                  <p className="text-sm text-muted-foreground">
                    <code className="bg-muted px-1 rounded">SarosFarmService.unStakePool</code> unstakes LP tokens from a farming pool.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold mb-1">Claim Rewards</h3>
                  <p className="text-sm text-muted-foreground">
                    <code className="bg-muted px-1 rounded">SarosFarmService.claimReward</code> claims accumulated rewards from a farming pool.
                  </p>
                </div>
              </CardContent>
            </Card>
